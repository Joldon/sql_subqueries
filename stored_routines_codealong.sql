...
create function advance_per_author(
amount float,
percentage int)
returns float(2)
deterministic
...
DELIMITER $$
create procedure get_phone (IN first_name varchar(255), IN last_name varchar(255), OUT author_phone varchar(255))
BEGIN
SELECT 
phone 
INTO author_phone
...
CALL get_phone("Dirk", "Stringer", @dirk_phone);

SELECT @dirk_phone;

/* Challenge: create a stored procedure that takes an author name and last name as input
and outputs their total profit
*/